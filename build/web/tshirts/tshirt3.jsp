...
<img STYLE="position:absolute; TOP:300px; LEFT:170px; WIDTH:350px; HEIGHT:350px" src="${pageContext.request.contextPath}/menu_assets/images/shirt/t3.png"/>
<div class="wrapper">
 ...
 try {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/shopping_cart?zeroDateTimeBehavior=convertToNull&serverTimezone=UTC","root","root");
            ...
            rs = stmt.executeQuery("SELECT * FROM product WHERE product_id = 3");
            String lastName;
            while ( rs.next() ) {%>
            <h2 Style="font-size: 2.2em; font-weight: bolder;">
...
wydłużyć się w związku obecną sytuacją</li>
 ...
 %>
				...
				<td> <input class="sub"  type="submit" value="DODAJ DO KOSZYKA" name="t3"></td>
                                </form>
                       <form action="${pageContext.request.contextPath}/Heart" method="get">
                           <td><input type="hidden" name="productId" value="3"></td>
				<td><input class="sub"  type="submit" value="&#9825; &nbsp;DODAJ DO WISHLIST" name="t3"></td>
                       </form>
                    </div> <!-- right-3 -->
