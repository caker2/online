...
<img STYLE="position: relative; TOP:150px;margin-left:-250px;" src="menu_assets/images/napisy/akcesoria.png" alt="koszulki"</img>
</a>
   <%
 ...
 try {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/shopping_cart?zeroDateTimeBehavior=convertToNull&serverTimezone=UTC","root","root");
            ...
            rs = stmt.executeQuery("SELECT * FROM product WHERE cat_id=5 ");
            String lastName;
            while ( rs.next() ) {%>
