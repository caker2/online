...
<%@ page import="com.example.service.factory.CartFactory" %>
...
%>
  ...
  <img src="${pageContext.request.contextPath}/menu_assets/images/text.png" />
     ...
     <img STYLE="position:absolute; TOP:350px; LEFT:700px;" src="${pageContext.request.contextPath}/menu_assets/images/koszyk.png"/>
<%
		...
		<% for(Cart cart : result) { %>
				...
				<td><%= cart.getPrice() %></td>
                                ...
                                <td>
                                    ...
                                    <a href="delete_controller.jsp?product_id=<%=cart.getProductId()%>"><submit class="subl"><i class="fas fa-times"></i></submit><br><br></a>
...
try{  //Registering the Driver
      ...
      //Retrieving the data
      ResultSet rs = stmt.executeQuery("SELECT SUM(price) FROM cart WHERE uid =" + session.getAttribute("id"));
