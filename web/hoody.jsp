...
<img STYLE="position: relative; TOP:150px;margin-left:-250px;" src="menu_assets/images/napisy/bluzy.png" alt="koszulki"</img>
</a>
   <%
 ...
 try {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/shopping_cart?zeroDateTimeBehavior=convertToNull&serverTimezone=UTC","root","root");
            ...
            rs = stmt.executeQuery("SELECT * FROM product WHERE cat_id=2 ");
            String lastName;
            while ( rs.next() ) {%>
 ...
 %>
   ...
   <footer Style="position: absolute; top:1650px;">
  ...
  <script>
    ...
    alert('Zaloguj się!');
        ...
        $(".fa-shopping-cart").click(function(ev){
    alert('Zaloguj się!');
        })
      }
  </script>
